...
from getDataAndLabelsSSVEP2 import getDataAndLabels, channelsSamplesTrialKernels, getConfusionMatrixNames, getNumClasses
...
class SSVEPExperiment():
    ...
    def trainAndPredict(
        ...
        model = EEGNet_SSVEP(nb_classes = getNumClasses(), Chans = self.chans, Samples = self.samples, 
